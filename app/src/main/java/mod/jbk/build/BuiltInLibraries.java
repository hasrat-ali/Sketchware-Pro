...
public class BuiltInLibraries {
    ...
    public static String ANDROIDX_ACTIVITY = "activity-1.9.3";
    public static String ANDROIDX_ANNOTATION_EXPERIMENTAL = "annotation-experimental-1.4.1";
    public static String ANDROIDX_ANNOTATION_JVM = "annotation-jvm-1.8.1";
    ...
    public static String ANDROIDX_CONSTRAINTLAYOUT_CORE = "constraintlayout-core-1.1.0";
    public static String ANDROIDX_CONSTRAINTLAYOUT = "constraintlayout-2.2.0";
    public static String ANDROIDX_COORDINATORLAYOUT = "coordinatorlayout-1.2.0";
    public static String ANDROIDX_CORE_KTX = "core-ktx-1.16.0-alpha01";
    public static String ANDROIDX_CORE_VIEWTREE = "core-viewtree-1.0.0-alpha01";
    public static String ANDROIDX_CORE = "core-1.16.0-alpha01";
    ...
    public static String ANDROIDX_DYNAMICANIMATION = "dynamicanimation-1.0.0";
    ...
    public static String ANDROIDX_ROOM_COMMON = "room-common-2.5.0";
    public static String ANDROIDX_ROOM_RUNTIME = "room-runtime-2.5.0";
    ...
    public static String ANDROIDX_SQLITE_FRAMEWORK = "sqlite-framework-2.3.0";
    public static String ANDROIDX_SQLITE = "sqlite-2.3.0";
    ...
    public static String ANDROIDX_WEBKIT = "webkit-1.11.0-alpha02";
    public static String ANDROIDX_WORK_RUNTIME_KTX = "work-runtime-ktx-2.8.1";
    public static String ANDROIDX_WORK_RUNTIME = "work-runtime-2.8.1";
    public static String LOTTIE = "lottie-6.5.2";
    public static String AUDIENCE_NETWORK_SDK = "audience-network-sdk-5.9.0";
    ...
    public static String PLAY_SERVICES_ADS_BASE = "play-services-ads-base-23.6.0";
    public static String PLAY_SERVICES_ADS_IDENTIFIER = "play-services-ads-identifier-18.0.0";
    public static String PLAY_SERVICES_ADS_LITE = "play-services-ads-lite-23.6.0";
    public static String PLAY_SERVICES_ADS = "play-services-ads-23.6.0";
    ...
    public static String PLAY_SERVICES_MAPS = "play-services-maps-19.0.0";
    ...
    public static String USER_MESSAGING_PLATFORM = "user-messaging-platform-3.1.0";
    public static String JSR305 = "jsr305-3.0.2";
    public static String GSON = "gson-2.11.0";
    public static String ERROR_PRONE_ANNOTATIONS = "error_prone_annotations-2.27.0";
    ...
    public static String FIREBASE_DYNAMIC_LINKS = "firebase-dynamic-links-22.1.0";
    ...
    public static String ONESIGNAL = "OneSignal-5.1.23";
    public static String ONESIGNAL_CORE = "core-5.1.23";
    public static String ONESIGNAL_IN_APP_MESSAGES = "in-app-messages-5.1.23";
    public static String ONESIGNAL_LOCATION = "location-5.1.23";
    public static String ONESIGNAL_NOTIFICATIONS = "notifications-5.1.23";
    ...
    public static String KOTLIN_STDLIB = "kotlin-stdlib-1.9.0";
    public static String KOTLINX_COROUTINES_ANDROID = "kotlinx-coroutines-android-1.7.3";
    public static String KOTLINX_COROUTINES_CORE_JVM = "kotlinx-coroutines-core-jvm-1.7.3";
    public static String KOTLINX_COROUTINES_PLAY_SERVICES = "kotlinx-coroutines-play-services-1.7.3";
    ...
    public static final BuiltInLibrary[] KNOWN_BUILT_IN_LIBRARIES = {
            new BuiltInLibrary(ANDROID_YOUTUBE_PLAYER, List.of(ANDROIDX_APPCOMPAT, ANDROIDX_LIFECYCLE_COMMON, ANDROIDX_RECYCLERVIEW,
                    KOTLIN_STDLIB), "com.pierfrancescosoffritti.androidyoutubeplayer"),

            new BuiltInLibrary(ANDROIDX_ACTIVITY, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_COLLECTION_JVM, ANDROIDX_CORE,
                    ANDROIDX_LIFECYCLE_COMMON, ANDROIDX_LIFECYCLE_RUNTIME,
                    ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE, ANDROIDX_LIFECYCLE_VIEWMODEL,
                    ANDROIDX_SAVEDSTATE, ANDROIDX_TRACING, KOTLIN_STDLIB,
                    KOTLINX_COROUTINES_CORE_JVM), "androidx.activity"),

            new BuiltInLibrary(ANDROIDX_ANNOTATION_EXPERIMENTAL, List.of(KOTLIN_STDLIB)),

            new BuiltInLibrary(ANDROIDX_ANNOTATION_JVM, List.of(KOTLIN_STDLIB)),
            ...
            new BuiltInLibrary(ANDROIDX_APPCOMPAT, List.of(ANDROIDX_ACTIVITY, ANDROIDX_ANNOTATION_JVM, ANDROIDX_APPCOMPAT_RESOURCES,
                    ...
                    ANDROIDX_SAVEDSTATE, KOTLIN_STDLIB), "androidx.appcompat"),
            ...
            new BuiltInLibrary(ANDROIDX_COLLECTION_JVM, List.of(ANDROIDX_ANNOTATION_JVM, KOTLIN_STDLIB)),
            ...
            new BuiltInLibrary(ANDROIDX_CORE_KTX, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_CORE, KOTLIN_STDLIB)),

            new BuiltInLibrary(ANDROIDX_CORE_VIEWTREE, List.of(KOTLIN_STDLIB), "androidx.core.viewtree"),
            ...
            new BuiltInLibrary(ANDROIDX_CORE, List.of(ANDROIDX_ANNOTATION_EXPERIMENTAL, ANDROIDX_ANNOTATION_JVM,
                    ...
                    ANDROIDX_LIFECYCLE_RUNTIME, ANDROIDX_TRACING,
                    ANDROIDX_VERSIONEDPARCELABLE, KOTLIN_STDLIB), "androidx.core"),
            ...
            new BuiltInLibrary(ANDROIDX_CREDENTIALS_PLAY_SERVICES_AUTH, List.of(ANDROIDX_CREDENTIALS, PLAY_SERVICES_AUTH, PLAY_SERVICES_FIDO, PLAY_SERVICES_TASKS,
                    GOOGLEID, KOTLIN_STDLIB), "androidx.credentials.play.services.auth"),

            new BuiltInLibrary(ANDROIDX_CREDENTIALS, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_CREDENTIALS_PLAY_SERVICES_AUTH, KOTLIN_STDLIB,
                    KOTLINX_COROUTINES_CORE_JVM), "androidx.credentials"),
            ...
            new BuiltInLibrary(ANDROIDX_DYNAMICANIMATION, List.of(ANDROIDX_COLLECTION_JVM, ANDROIDX_CORE, ANDROIDX_LEGACY_SUPPORT_CORE_UTILS)),
            ...
            new BuiltInLibrary(ANDROIDX_FRAGMENT, List.of(ANDROIDX_ACTIVITY, ANDROIDX_ANNOTATION_EXPERIMENTAL, ANDROIDX_ANNOTATION_JVM,
                    ...
                    KOTLIN_STDLIB), "androidx.fragment"),
            ...
            new BuiltInLibrary(ANDROIDX_LIFECYCLE_COMMON, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_LIFECYCLE_LIVEDATA_CORE,
                    ...
                    ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE, ANDROIDX_LIFECYCLE_VIEWMODEL,
                    KOTLIN_STDLIB, KOTLINX_COROUTINES_ANDROID)),
            ...
            new BuiltInLibrary(ANDROIDX_LIFECYCLE_PROCESS, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_LIFECYCLE_COMMON,
                    ...
                    ANDROIDX_LIFECYCLE_RUNTIME, ANDROIDX_LIFECYCLE_SERVICE,
                    ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE, ANDROIDX_LIFECYCLE_VIEWMODEL,
                    ANDROIDX_STARTUP_RUNTIME, KOTLIN_STDLIB)),
            ...
            new BuiltInLibrary(ANDROIDX_LIFECYCLE_RUNTIME, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_CORE_COMMON, ANDROIDX_CORE_RUNTIME,
                    ...
                    ANDROIDX_LIFECYCLE_VIEWMODEL, KOTLIN_STDLIB), "androidx.lifecycle.runtime"),
            ...
            new BuiltInLibrary(ANDROIDX_LIFECYCLE_SERVICE, List.of(ANDROIDX_LIFECYCLE_COMMON, ANDROIDX_LIFECYCLE_LIVEDATA_CORE,
                    ...
                    ANDROIDX_LIFECYCLE_VIEWMODEL, KOTLIN_STDLIB)),
            ...
            new BuiltInLibrary(ANDROIDX_ADS_ADSERVICES_JAVA, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_CONCURRENT_FUTURES, ANDROIDX_CORE_KTX,
                    ANDROIDX_ADS_ADSERVICES, GUAVA, KOTLIN_STDLIB,
            ...
            new BuiltInLibrary(ANDROIDX_ADS_ADSERVICES, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_CORE_KTX, ANDROIDX_ADS_ADSERVICES_JAVA,
                    KOTLIN_STDLIB, KOTLINX_COROUTINES_CORE_JVM)),

            new BuiltInLibrary(ANDROIDX_RECYCLERVIEW, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_COLLECTION_JVM, ANDROIDX_CORE,
                    ANDROIDX_CUSTOMVIEW_POOLINGCONTAINER, ANDROIDX_CUSTOMVIEW, ANDROIDX_LEGACY_SUPPORT_CORE_UI,
                    ANDROIDX_VIEWPAGER2), "androidx.recyclerview"),

            new BuiltInLibrary(ANDROIDX_ROOM_COMMON, List.of(ANDROIDX_ANNOTATION_JVM)),

            new BuiltInLibrary(ANDROIDX_ROOM_RUNTIME, List.of(ANDROIDX_ANNOTATION_EXPERIMENTAL, ANDROIDX_CORE_RUNTIME, ANDROIDX_ROOM_COMMON,
            ...
            new BuiltInLibrary(ANDROIDX_SAVEDSTATE, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_CORE_COMMON, ANDROIDX_LIFECYCLE_COMMON,
                    KOTLIN_STDLIB), "androidx.savedstate"),

            new BuiltInLibrary(ANDROIDX_SLIDINGPANELAYOUT, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_CORE, ANDROIDX_CUSTOMVIEW)),

            new BuiltInLibrary(ANDROIDX_SQLITE_FRAMEWORK, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_SQLITE, KOTLIN_STDLIB)),

            new BuiltInLibrary(ANDROIDX_SQLITE, List.of(ANDROIDX_ANNOTATION_JVM, KOTLIN_STDLIB)),

            new BuiltInLibrary(ANDROIDX_STARTUP_RUNTIME, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_LIFECYCLE_COMMON, ANDROIDX_TRACING,
                    KOTLIN_STDLIB), "androidx.startup"),
            ...
            new BuiltInLibrary(ANDROIDX_WEBKIT, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_CORE)),

            new BuiltInLibrary(ANDROIDX_WORK_RUNTIME_KTX, List.of(ANDROIDX_WORK_RUNTIME, KOTLIN_STDLIB, KOTLINX_COROUTINES_ANDROID)),
            ...
            new BuiltInLibrary(ANDROIDX_WORK_RUNTIME, List.of(ANDROIDX_ANNOTATION_EXPERIMENTAL, ANDROIDX_CORE, ANDROIDX_LIFECYCLE_LIVEDATA,
                    ...
                    ANDROIDX_SQLITE_FRAMEWORK, ANDROIDX_SQLITE, ANDROIDX_STARTUP_RUNTIME,
                    KOTLIN_STDLIB), "androidx.work"),

            new BuiltInLibrary(LOTTIE, List.of(ANDROIDX_APPCOMPAT, OKIO_JVM), "com.airbnb.lottie"),

            new BuiltInLibrary(AUDIENCE_NETWORK_SDK, List.of(PLAY_SERVICES_BASEMENT)),
            ...
            new BuiltInLibrary(PLAY_SERVICES_ADS, List.of(ANDROIDX_BROWSER, ANDROIDX_COLLECTION_JVM, ANDROIDX_CORE,
                    ANDROIDX_ADS_ADSERVICES_JAVA, ANDROIDX_ADS_ADSERVICES,
                    ANDROIDX_WEBKIT, PLAY_SERVICES_ADS_BASE, PLAY_SERVICES_ADS_IDENTIFIER,
                    PLAY_SERVICES_ADS_LITE, PLAY_SERVICES_APPSET, PLAY_SERVICES_BASEMENT,
            ...
            new BuiltInLibrary(PLAY_SERVICES_LOCATION, List.of(PLAY_SERVICES_BASE, PLAY_SERVICES_BASEMENT, PLAY_SERVICES_TASKS, KOTLIN_STDLIB,
                    KOTLINX_COROUTINES_ANDROID, KOTLINX_COROUTINES_CORE_JVM)),

            new BuiltInLibrary(PLAY_SERVICES_MAPS, List.of(ANDROIDX_FRAGMENT, PLAY_SERVICES_BASE, PLAY_SERVICES_BASEMENT,
            ...
            new BuiltInLibrary(GOOGLEID, List.of(KOTLIN_STDLIB)),
            ...
            new BuiltInLibrary(MATERIAL, List.of(ANDROIDX_ACTIVITY, ANDROIDX_ANNOTATION_EXPERIMENTAL, ANDROIDX_ANNOTATION_JVM,
                    ...
                    ANDROIDX_LIFECYCLE_RUNTIME, ANDROIDX_RECYCLERVIEW,
                    ANDROIDX_TRANSITION, ANDROIDX_VECTORDRAWABLE, ANDROIDX_VIEWPAGER2,
                    ERROR_PRONE_ANNOTATIONS, KOTLIN_STDLIB), "com.google.android.material"),
            ...
            new BuiltInLibrary(RECAPTCHA, List.of(PLAY_SERVICES_BASEMENT, PLAY_SERVICES_TASKS, INTEGRITY, KOTLIN_STDLIB,
                    KOTLINX_COROUTINES_ANDROID, KOTLINX_COROUTINES_PLAY_SERVICES)),
            ...
            new BuiltInLibrary(FIREBASE_APPCHECK, List.of(ANDROIDX_ANNOTATION_JVM, PLAY_SERVICES_BASE, PLAY_SERVICES_TASKS,
                    FIREBASE_APPCHECK_INTEROP, FIREBASE_COMPONENTS, KOTLIN_STDLIB)),
            ...
            new BuiltInLibrary(FIREBASE_AUTH, List.of(ANDROIDX_BROWSER, ANDROIDX_COLLECTION_JVM,
                    ...
                    FIREBASE_COMPONENTS, KOTLIN_STDLIB)),

            new BuiltInLibrary(FIREBASE_COMMON, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_CONCURRENT_FUTURES, PLAY_SERVICES_BASEMENT,
                    PLAY_SERVICES_TASKS, FIREBASE_ANNOTATIONS, FIREBASE_COMPONENTS,
                    KOTLIN_STDLIB, KOTLINX_COROUTINES_PLAY_SERVICES), "com.google.firebase"),
            ...
            new BuiltInLibrary(FIREBASE_DYNAMIC_LINKS, List.of(ANDROIDX_ANNOTATION_JVM, PLAY_SERVICES_BASE, PLAY_SERVICES_BASEMENT,
                    PLAY_SERVICES_TASKS, FIREBASE_AUTH_INTEROP, FIREBASE_COMMON,
                    FIREBASE_COMPONENTS, FIREBASE_MEASUREMENT_CONNECTOR, KOTLIN_STDLIB)),
            ...
            new BuiltInLibrary(FIREBASE_INSTALLATIONS, List.of(PLAY_SERVICES_TASKS, FIREBASE_ANNOTATIONS, FIREBASE_COMMON, FIREBASE_COMPONENTS,
                    FIREBASE_INSTALLATIONS_INTEROP, KOTLIN_STDLIB)),
            ...
            new BuiltInLibrary(FIREBASE_MESSAGING, List.of(ANDROIDX_ANNOTATION_JVM, TRANSPORT_API, TRANSPORT_BACKEND_CCT, TRANSPORT_RUNTIME,
                    ...
                    FIREBASE_MEASUREMENT_CONNECTOR, KOTLIN_STDLIB), "com.google.firebase.messaging"),
            ...
            new BuiltInLibrary(ONESIGNAL, List.of(ONESIGNAL_CORE, ONESIGNAL_IN_APP_MESSAGES, ONESIGNAL_LOCATION,
                    ONESIGNAL_NOTIFICATIONS), "com.onesignal"),

            new BuiltInLibrary(ONESIGNAL_CORE, List.of(ANDROIDX_APPCOMPAT, KOTLINX_COROUTINES_ANDROID, KOTLINX_COROUTINES_CORE_JVM), "com.onesignal.core"),

            new BuiltInLibrary(ONESIGNAL_IN_APP_MESSAGES, List.of(ANDROIDX_BROWSER, ANDROIDX_CARDVIEW, ONESIGNAL_CORE, ONESIGNAL_NOTIFICATIONS,
                    KOTLINX_COROUTINES_ANDROID, KOTLINX_COROUTINES_CORE_JVM)),

            new BuiltInLibrary(ONESIGNAL_LOCATION, List.of(PLAY_SERVICES_LOCATION, ONESIGNAL_CORE, KOTLINX_COROUTINES_ANDROID,
                    KOTLINX_COROUTINES_CORE_JVM)),

            new BuiltInLibrary(ONESIGNAL_NOTIFICATIONS, List.of(ANDROIDX_WORK_RUNTIME_KTX, ANDROIDX_WORK_RUNTIME, FIREBASE_MESSAGING,
                    ONESIGNAL_CORE, KOTLINX_COROUTINES_ANDROID,
                    KOTLINX_COROUTINES_CORE_JVM)),

            new BuiltInLibrary(OKHTTP, List.of(OKIO_JVM)),

            new BuiltInLibrary(OKIO_JVM),
            ...
            new BuiltInLibrary(KOTLINX_COROUTINES_ANDROID, List.of(KOTLINX_COROUTINES_CORE_JVM)),

            new BuiltInLibrary(KOTLINX_COROUTINES_CORE_JVM, List.of(JETBRAINS_ANNOTATIONS)),

            new BuiltInLibrary(KOTLINX_COROUTINES_PLAY_SERVICES, List.of(PLAY_SERVICES_TASKS, KOTLINX_COROUTINES_CORE_JVM)),
