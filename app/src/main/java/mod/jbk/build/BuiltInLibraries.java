...
public class BuiltInLibraries {
    ...
    public static final BuiltInLibrary[] KNOWN_BUILT_IN_LIBRARIES = {
            ...
            new BuiltInLibrary(ANDROIDX_DYNAMICANIMATION, List.of(ANDROIDX_COLLECTION_JVM, ANDROIDX_CORE, ANDROIDX_LEGACY_SUPPORT_CORE_UTILS), "androidx.dynamicanimation"),
